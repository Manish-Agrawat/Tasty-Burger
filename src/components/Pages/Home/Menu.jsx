...
import Image3 from "../../../assets/assets/menu/burger-14.jpg";
import Image4 from "../../../assets/assets/menu/burger-13.jpg";
          ...
          <Row className="pt-5">
            <Col sm={6} lg={5}>
              <div className="ads_box ads_img1 mb-5 mb-md-0">
                ...
                <h5>CHEESE FRIES</h5>
                <Link to="/learnmore" className="btn btn_red px-4 rounded-0">
                  Learn More
                </Link>
              </div>
            </Col>
